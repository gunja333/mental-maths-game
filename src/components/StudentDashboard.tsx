...
const StudentDashboard: React.FC = () => {
  ...
  if (isGeneratingImage) {
      return <ImageGeneratorView onBack={() => setIsGeneratingImage(false)} />;
  }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <main className="space-y-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md">
            <h3 className="font-bold text-xl text-gray-800 mb-2">Creative Corner</h3>
            <p className="text-gray-600 mb-4">Unleash your creativity! Describe an image and let our AI bring it to life.</p>
            <button
                onClick={() => setIsGeneratingImage(true)}
                className="w-full md:w-auto px-6 py-3 bg-brand-primary text-white font-bold rounded-lg shadow-md hover:bg-indigo-700 transition-all duration-300 transform hover:-translate-y-1"
            >
                Open AI Image Playground
            </button>
          </div>
